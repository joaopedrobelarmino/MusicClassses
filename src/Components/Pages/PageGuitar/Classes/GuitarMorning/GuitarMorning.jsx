...
import styles from './GuitarMorning.module.css';
...
const GuitarMorning = () => {
  return (
    <div>
      <Header />
      <div className={styles.GuitarMorning}>
        <div>
          <img src={Image} />
        </div>
        <div>
          <h1>Bem vindo a inscrição do curso <span>Guitarra/Manha</span>.</h1>
        </div>
      </div>
