...
import styles from './GuitarNight.module.css'
...
const GuitarNight = () => {
  return (
    <div>
    <Header />
    <div className={styles.GuitarNight}>
      <div>
        <img src={Image} />
      </div>
      <div>
        <h1>Bem vindo a inscrição do curso <span>Guitarra/Noite</span>.</h1>
      </div>
    </div>
